namespace UnifierTSL.Plugins
{
    ...
    public interface IConfigRegistrationBuilder<TConfig> where TConfig : class
    {
        /// <summary>
        ...
        IConfigRegistrationBuilder<TConfig> WithDefault(Func<TConfig> factory);
        ...
        /// <returns>Builder for chaining.</returns>
        IConfigRegistrationBuilder<TConfig> OnSerializationFailure(SerializationFailureHandling handling);
        ...
        /// </param>
        /// <returns>Builder for chaining.</returns>
        IConfigRegistrationBuilder<TConfig> OnDeserializationFailure(DeserializationFailureHandling handling, bool autoPersistFallback = true);
        ...
        /// <returns>Builder for chaining.</returns>
        IConfigRegistrationBuilder<TConfig> TriggerReloadOnExternalChange(bool enabled);
        ...
        /// <returns>Builder for chaining.</returns>
        IConfigRegistrationBuilder<TConfig> WithValidation(Func<TConfig, bool> validator);
