...
namespace UnifierTSL.ConsoleClient.Shell
{
    internal static class TerminalCellWidth
    {
        ...
        public static int FindUtf16IndexForColumns(string text, int columns, out int actualColumns)
        {
            ArgumentNullException.ThrowIfNull(text);
        ...
        public static int TakeUtf16LengthByColumns(string text, int startIndex, int maxColumns, out int consumedColumns)
        {
            ArgumentNullException.ThrowIfNull(text);
