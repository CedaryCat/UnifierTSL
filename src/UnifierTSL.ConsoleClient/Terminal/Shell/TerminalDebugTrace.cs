...
namespace UnifierTSL.Terminal.Shell
{
    internal static class TerminalDebugTrace
    {
        ...
        private static readonly bool ScreenDumpEnabled = IsScreenDumpEnabled();
        ...
        public static void DumpConsoleSlice(
            ...
            if (!ScreenDumpEnabled || !OperatingSystem.IsWindows()) {
                return;
            }
        ...
        private static bool IsScreenDumpEnabled() {
            return true;
        }
